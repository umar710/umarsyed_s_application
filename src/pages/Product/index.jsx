              ...
              <div className="w-full mb-8">
                <div className="relative w-full bg-primary rounded-lg overflow-hidden">
                  <div className="relative w-full aspect-square max-w-[584px] mx-auto">
                    ...
                    {/* Navigation Arrows */}
                    <div className="absolute bottom-0 left-0 right-0 flex justify-between items-center px-4 pb-64 z-20">
              ...
              <div className="relative w-full mb-6">
                <div className="flex flex-col justify-start items-start w-full">
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                      <div className="bg-secondary rounded-[10px] p-4 sm:p-5 shadow-lg max-w-md w-full max-h-[80vh] overflow-y-auto">
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="text-[16px] sm:text-[18px] font-segoe font-normal leading-[22px] sm:leading-[24px] text-primary">
                            UMF & MGO Information
                          </h3>
                          <button
                        ...
                        <div className="bg-[#f1f1f1] rounded-[5px] p-3 sm:p-4 mb-4">
                          <p className="text-[14px] sm:text-[16px] font-inter font-normal leading-[20px] sm:leading-[24px] text-primary mb-3">
                            <span className="font-segoe font-bold">UMF</span> is the strength and
                          ...
                          <div className="flex flex-wrap gap-1 sm:gap-2 mb-3">
                            {[
                              ...
                              <div key={index} className="flex flex-col items-start gap-1">
                                <span
                                  className="text-[12px] sm:text-[14px] font-segoe font-semibold leading-[16px] sm:leading-[19px]"
                                  style={{ color: rating?.color }}
                                >
                                  {rating?.level}
                                </span>
                                <div
                                  className="w-[40px] sm:w-[56px] h-[3px] sm:h-[4px]"
                        ...
                        <div className="bg-[#f1f1f1] rounded-[5px] p-3 sm:p-4 mb-4">
                          <p className="text-[14px] sm:text-[16px] font-inter font-normal leading-[20px] sm:leading-[24px] text-primary mb-3">
                            <span className="font-segoe font-bold">MGO</span> is the key natural
                            compound that gives Manuka honey its special antibacterial strength.
                          </p>
                          <div className="flex flex-wrap gap-1 sm:gap-2 mb-3">
                            {[
                              { level: '10+', color: '#e87722', mgo: '263+' },
                  ...
                  <div className="flex flex-wrap gap-6 lg:gap-[38px] mb-8">
                    <img
                      src="/images/img_certifications.png"
                      alt="Certification 1"
                      className="w-[70px] h-[70px]"
                    />
                    <img
                      src="/images/img_certifications_70x70.png"
                      alt="Certification 2"
                      className="w-[70px] h-[70px]"
                    />
                    <img
                      src="/images/img_certifications_1.png"
                      alt="Certification 3"
                      className="w-[70px] h-[70px]"
                    />
                    <img
                      src="/images/img_certifications_2.png"
                      alt="Certification 4"
                      className="w-[70px] h-[70px]"
                    />
                    <img
                      src="/images/img_certifications_3.png"
                      alt="Certification 5"
                      className="w-[70px] h-[70px]"
                    />
                    <img
                      src="/images/img_certifications_4.png"
                      alt="Certification 6"
                      className="w-[70px] h-[70px]"
                    />
                  </div>
                  ...
                  <div className="w-full mb-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-2">
                      <img
                        src="/images/img_label_label_paints.png"
                        alt="125g option"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] border-2 border-[#f1b434] cursor-pointer"
                      />
                      <img
                        src="/images/img_label_label_paints_130x130.png"
                        alt="250g option"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                      <img
                        src="/images/img_label_label_paints_1.png"
                        alt="500g option"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                      <img
                        src="/images/img_label_label_paints_2.png"
                        alt="1kg option"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                    </div>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      <img
                        src="/images/img_label_label_paints_3.png"
                        alt="Additional option 1"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                      <img
                        src="/images/img_label_label_paints_4.png"
                        alt="Additional option 2"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                      <img
                        src="/images/img_label_label_paints_5.png"
                        alt="Additional option 3"
                        className="w-full max-w-[130px] h-[130px] rounded-[24px] cursor-pointer"
                      />
                    </div>
                  </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 mb-6">
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <span
                              className={`text-[16px] font-segoe font-normal leading-[17px] text-center ${
                        ...
                        >
                          <div className="flex justify-between items-center gap-7">
                            <span
                              className={`text-[15px] font-segoe font-normal leading-[17px] text-center ${
